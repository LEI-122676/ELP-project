...
public class JavardairLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "T__1", "T__2", "T__3", "T__4", "T__5", "LITERAL", "VARIABLE", 
			"OPERATOR", "EQUAL", "PLUS", "MINUS", "TIMES", "DIVISION", "MODULE", 
			"EQUALSTO", "DIFFERENT", "LESSTHEN", "LESSOREQUALTO", "GREATERTHEN", 
			"GREATEROREQUALTO", "OPENPARENTHESIS", "CLOSEPARENTHESIS", "OPENBRACKETS", 
